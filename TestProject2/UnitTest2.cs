...
namespace TestProject2
{
    ...
    public class UnitTest2
    {
        ...
        {
            Console.WriteLine("this is Console out");
            TestContext.WriteLine("[TEST NUMBER 3]");
            TestContext.WriteLine("[TestMethod3]this is line number 1");
            TestContext.WriteLine("[TestMethod3]this is line number 2");
            TestContext.WriteLine("[TestMethod3]this is line number 3");
            ...
            Console.WriteLine("this is Console out2");
            ...
            TestContext.WriteLine("$Link=http://www.ynet.ci.il,Title=ynet$" );
        }

        [TestMethod]
        public void TestMethod4444()
        {
            TestContext.WriteLine("[TEST NUMBER 42]");
